...
const char* BLEManager::deviceServiceCharacteristicUuid = "19b10001-e8f2-537e-4f6c-d104768a1214";
BLEService BLEManager::configurationService(deviceServiceUuid);
BLEStringCharacteristic BLEManager::configurationCharacteristic(deviceServiceCharacteristicUuid, BLERead | BLEWrite, 512);

void BLEManager::initializeBLE() {
